...
namespace mindquantum::decompositions {
    ...
    template <typename derived_t, typename kinds_t, uint32_t num_targets, num_control_t num_controls,
...
namespace mindquantum::decompositions {
    ...
    class GateDecompositionRuleCXX17
     ...
     public:
        ...
        using self_t
            = GateDecompositionRuleCXX17<derived_t, kinds_t, num_targets_, num_controls_, num_params_, atoms_t...>;
...
#include "decompositions/details/gate_decomposition_rule_cxx17.tpp"

...
namespace mindquantum::decompositions {
    ...
    auto AtomStorage::add_or_replace_atom(args_t&&... args) -> atom_t* {
        ...
        if (num_controls == any_control && it_begin->first.second == any_control) {
            ...
            const auto atom_match = [kind_match = kind_match,
                                     num_controls = num_controls](const map_t::value_type& item) {
    ...
    auto AtomStorage::add_or_non_replace_atom_(args_t&&... args) -> atom_t* {
        ...
        const auto atom_match = [&kind, num_controls = num_controls](const map_t::value_type& item) {

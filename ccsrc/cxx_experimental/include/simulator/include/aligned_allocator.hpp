...
public:
    ...
    static_assert(alignment >= DEFAULT_ALIGNMENT);
...
template <class T, unsigned int alignemnt>
void aligned_allocator<T, alignemnt>::deallocate(pointer p, size_type /* unused */) const
{
    aligned_free(p);
}

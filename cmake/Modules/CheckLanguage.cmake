...
macro(check_language lang)
  if(NOT DEFINED CMAKE_${lang}_COMPILER)
    ...
    if(${lang} STREQUAL NVCXX)
      set(extra_compiler_variables_pre
          "set(_CMAKE_NVCXX_USE_FAST_SEARCH ${_CMAKE_NVCXX_USE_FAST_SEARCH})
...
file(WRITE \"\${CMAKE_CURRENT_BINARY_DIR}/result.cmake\"
  ...
  \"${extra_compiler_variables}\\n\"
    ...
    file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/CMakeFiles/Check${lang}/CMakeLists.txt" "${_cl_content}")
    ...
    execute_process(
      ...
      COMMAND ${CMAKE_COMMAND} . -G ${CMAKE_GENERATOR} -A "${CMAKE_GENERATOR_PLATFORM}" -T "${CMAKE_GENERATOR_TOOLSET}"
              ${_D_CMAKE_GENERATOR_INSTANCE} ${_D_CMAKE_MAKE_PROGRAM} ${_D_CMAKE_TOOLCHAIN_FILE}

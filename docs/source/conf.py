...
project = 'ProjectQ-C++'
description = 'A C++ processing pipeline for ProjectQ'
...
release = importlib_metadata.version('hiq-projectq-cpp')  # Full version string
...
breathe_projects = {'projectqcxx': '../doxygen/xml'}
